...
const NylonContext = React.createContext()

let keyringLoadAll = false

const NylonContextProvider = props => {
    ...
    return (
        <NylonContext.Provider value={{state, setCurrentAccount}}>
            {props.children}
        </NylonContext.Provider>
    )
}

// prop typechecking
NylonContextProvider.propTypes = {
    socket: PropTypes.string,
}

const useNylon = () => useContext(NylonContext)
const useNylonState = () => useContext(NylonContext).state

export {NylonContextProvider, useNylon, useNylonState}
